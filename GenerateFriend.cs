...
public class GenerateFriend : MonoBehaviour {
    int randomcount;
    ...
    void Start()
    {
        ...
        if (Physics.Raycast(ray5, 60f) == false)
        {
            ...
            if (randomcount >= 7)
            {
                ...
                //接続作成
                this.gameObject.GetComponent<Relationship6>().Obj_LowerLeft = obj5;
                obj5.GetComponent<Relationship6>().Obj_UpperRight = this.gameObject;
                //線を引く
        ...
        else
        {
            ...
            this.gameObject.GetComponent<Relationship6>().Obj_LowerLeft = null;
        }
        //左上のオブジェクト用
        //yield return new WaitForSeconds(waittimecount());
        ...
        if (Physics.Raycast(ray6, 60f) == false)
        {
            ...
            if (randomcount >= 7)
            {
                ...
                //接続作成
                this.gameObject.GetComponent<Relationship6>().Obj_UpperLeft = obj6;
                obj6.GetComponent<Relationship6>().Obj_LowerRight = this.gameObject;
                //線を引く
        ...
        else
        {
            ...
            this.gameObject.GetComponent<Relationship6>().Obj_UpperLeft = null;
        }
    }
