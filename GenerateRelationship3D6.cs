...
public class GenerateRelationship3D6 : MonoBehaviour {
    ...
    IEnumerator main()
    {
        if ((transform.position.x < 300) && (transform.position.x > -300) && (transform.position.z < 150) && (transform.position.z > -150))
        {
            ...
            if (Physics.Raycast(ray1, 400f) == false)
            {
            ...
            yield return new WaitForSeconds(waittimecount());
            if (Physics.Raycast(ray2, 400f) == false)
            {
            ...
            yield return new WaitForSeconds(waittimecount());
            if (Physics.Raycast(ray3, 400f) == false)
            {
            ...
            yield return new WaitForSeconds(waittimecount());
            if (Physics.Raycast(ray4, 400f) == false)
            {
            ...
            yield return new WaitForSeconds(waittimecount());
            if (Physics.Raycast(ray5, 400f) == false)
            {
            ...
            yield return new WaitForSeconds(waittimecount());
            if (Physics.Raycast(ray6, 400f) == false)
            {
